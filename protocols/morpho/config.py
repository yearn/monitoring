...
VAULTS_V1_BY_CHAIN: dict[Chain, tuple[VaultConfig, ...]] = {
    Chain.MAINNET: (
        ...
        VaultConfig("Yearn OG WETH", "0xE89371eAaAC6D46d4C3ED23453241987916224FC", 1),
        VaultConfig("Yearn OG USDC", "0xF9bdDd4A9b3A45f980e11fDDE96e16364dDBEc49", 3),
    ...
    Chain.KATANA: (
        ...
        VaultConfig("Gauntlet USDC", "0xE4248e2105508FcBad3fe95691551d1AF14015f7", 1, KATANA_USDC),
        VaultConfig(
