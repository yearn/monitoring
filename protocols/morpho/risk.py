...
MARKETS_RISK_1 = {
    Chain.MAINNET: [
        ...
        "0x34377fc4f617c51818e92c79df31ff270c6a91bc94ad32e367fdf59b9f4ac5dd",  # weETH/USDC -> lltv 77%, oracle: weETH/ETH exchange-rate adapter (weETH.getRate()) + Chainlink ETH/USD; Morpho dummy quote feed (USDC = $1).
...
MARKETS_RISK_2 = {
    Chain.MAINNET: [
        ...
        "0xd9d2fc090bdbab1804ea960dd6669b62357787e5816f575f14ca4e6d999614bf",  # USDe/RLUSD -> lltv 91.5%, oracle: Chainlink USDe/USD and Chainlink RLUSD/USD.
